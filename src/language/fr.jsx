...
export const schedule = {
  ...
  rooms_timeslots_header: "Salles associées aux plages horaires",
  rooms_timeslots_new: "Lier une salle à des plages",
  rooms_timeslots_modify: "Modifier une liaison",
  rooms_timeslots_room_select: "Choisir une salle : ",
  rooms_timeslots_room_checkAll: "Tout sélectionner",
  rooms_timeslots_room_uncheckAll: "Tout déselectionner",
  rooms_timeslots_date_select: "Choisir une date : ",
  rooms_timeslots_subm_select: "Choisir une soumission",
  rooms_timeslots_rooms: "Salles",
  rooms_timeslots_panel: "Lier une soumission à une plage",
  rooms_timeslots_empty: "Plage libre",
  rooms_location: "Lieu",
  ...
  rooms_av_options: [
    { name: "av", value: 0, label: "Ni audio ni vidéo" },
    { name: "av", value: 1, label: "Audio seulement" },
    { name: "av", value: 2, label: "Vidéo seulement" },
    { name: "av", value: 3, label: "Audiovisuel sans caméra" },
    { name: "av", value: 4, label: "Audiovisuel avec caméra" }
  ],
